...
//	public static final com.sun.jna.NativeLibrary JNA_NATIVE_LIB = com.sun.jna.NativeLibrary.getInstance(libusbone.LibusboneLibrary.JNA_LIBRARY_NAME, com.ochafik.lang.jnaerator.runtime.MangledFunctionMapper.DEFAULT_OPTIONS);
    ...
    public static interface libusb_class_code {
        ...
        /**
         * In the context of a \ref libusb_device_descriptor "device
         * descriptor",<br>
         * this bDeviceClass value indicates that each interface specifies
         * its<br>
     ...
     * \ref libusb_endpoint_descriptor::bEndpointAddress "endpoint address"
     * scheme.<br>
     ...
     * \ref libusb_endpoint_descriptor::bmAttributes "endpoint attributes"
     * field.<br>
     ...
     * \ref libusb_control_setup::bmRequestType "bmRequestType" field in
     * control<br>
     * transfers.<br>
    ...
    /**
     * \ingroup desc<br>
     * Synchronization type for isochronous endpoints. Values for bits 2:3 of
     * the<br>
    ...
    /**
     * \ingroup misc<br>
     * Error codes. Most libusb functions return 0 on success or one of
     * these<br>
     * codes on failure.<br>
...
//	public static final int INT_MIN = (nulllibusbone.LibusboneLibrary.INT_MAX - 1);
     ...
     * asynchronous<br>
     * transfers, you pass a pointer to a callback function of this type via
     * the<br>
     * \ref libusb_transfer::callback "callback" member of the
     * libusb_transfer<br>
     * structure. libusb will call this function later, when the transfer
     * has<br>
     * completed or failed. See \ref asyncio for more information.<br>
     * \param transfer The libusb_transfer struct the callback function is
     * being<br>
     * notified about.<br>
     * <i>native declaration : /usr/include/limits.h</i>
     */
     ...
     * read<br>
     * readiness, in WRITEFDS (if not NULL) for write readiness, and in
     * EXCEPTFDS<br>
     * (if not NULL) for exceptional conditions. If TIMEOUT is not NULL, time
     * out<br>
     * after waiting the interval specified therein. Returns the number of
     * ready<br>
     * descriptors, or -1 for errors.<br>
     * This function is a cancellation point and therefore not marked with<br>
     * __THROW.<br>
     * Original signature :
     * <code>int select(int, fd_set*, fd_set*, fd_set*, timeval*)</code><br>
     ...
     * __THROW.<br>
     * Original signature :
     * <code>int pselect(int, fd_set*, fd_set*, fd_set*, timespec*, const __sigset_t*)</code><br>
     ...
     * Original signature :
     * <code>int gettimeofday(timeval*, __timezone_ptr_t)</code><br>
     ...
     * Original signature :
     * <code>int settimeofday(timeval*, timezone*)</code><br>
     ...
     * Original signature :
     * <code>int getitimer(__itimer_which_t, itimerval*)</code><br>
     ...
     * Returns 0 on success, -1 on errors.<br>
     * Original signature :
     * <code>int setitimer(__itimer_which_t, itimerval*, itimerval*)</code><br>
     ...
     * FILE to TVP[1]. If TVP is a null pointer, use the current time
     * instead.<br>
     * Returns 0 on success, -1 on errors.<br>
     * Original signature :
     * <code>int utimes(__const char*, timeval[2])</code><br>
     * <i>native declaration : /usr/include/sys/time.h:137</i><br>
     *
     * @deprecated use the safer methods
     * {@link #utimes(java.lang.String, libusbone.timeval[])} and
     * {@link #utimes(com.sun.jna.Pointer, libusbone.timeval[])} instead
     */
     ...
     * Original signature :
     * <code>int lutimes(__const char*, timeval[2])</code><br>
     * <i>native declaration : /usr/include/sys/time.h:142</i><br>
     *
     * @deprecated use the safer methods
     * {@link #lutimes(java.lang.String, libusbone.timeval[])} and
     * {@link #lutimes(com.sun.jna.Pointer, libusbone.timeval[])} instead
     */
    @java.lang.Deprecated
     ...
     * {@link #futimes(int, libusbone.timeval[])} instead
     */
    @java.lang.Deprecated
    ...
    /**
     * Original signature :
     * <code>int gnu_dev_major(unsigned long long int)</code><br>
    ...
    /**
     * Original signature :
     * <code>int gnu_dev_minor(unsigned long long int)</code><br>
    ...
    /**
     * Original signature :
     * <code>int gnu_dev_makedev(unsigned int, unsigned int)</code><br>
    ...
    /**
     * Original signature :
     * <code>void libusb_set_debug(libusb_context*, int)</code><br>
    ...
    /**
     * Original signature :
     * <code>ssize_t libusb_get_device_list(libusb_context*, libusb_device***)</code><br>
    ...
    /**
     * Original signature :
     * <code>void libusb_free_device_list(libusb_device**, int)</code><br>
     * <i>native declaration : /usr/include/limits.h:853</i><br>
     *
     * @deprecated use the safer method
     * {@link #libusb_free_device_list(libusbone.LibusboneLibrary.libusb_device[], int)}
     * instead
     */
    @java.lang.Deprecated
    ...
    /**
     * Original signature :
     * <code>libusb_device* libusb_ref_device(libusb_device*)</code><br>
    ...
    /**
     * Original signature :
     * <code>void libusb_unref_device(libusb_device*)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_get_configuration(libusb_device_handle*, int*)</code><br>
     * <i>native declaration : /usr/include/limits.h:857</i><br>
     *
     * @deprecated use the safer methods
     * {@link #libusb_get_configuration(libusbone.LibusboneLibrary.libusb_device_handle, java.nio.IntBuffer)}
     * and
     * {@link #libusb_get_configuration(libusbone.LibusboneLibrary.libusb_device_handle, com.sun.jna.ptr.IntByReference)}
     * instead
     */
    @java.lang.Deprecated
    ...
    /**
     * Original signature :
     * <code>int libusb_get_device_descriptor(libusb_device*, libusb_device_descriptor*)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_get_active_config_descriptor(libusb_device*, libusb_config_descriptor**)</code><br>
     * <i>native declaration : /usr/include/limits.h:860</i><br>
     *
     * @deprecated use the safer method
     * {@link #libusb_get_active_config_descriptor(libusbone.LibusboneLibrary.libusb_device, libusbone.libusb_config_descriptor.ByReference[])}
     * instead
     */
    @java.lang.Deprecated
    ...
    /**
     * Original signature :
     * <code>int libusb_get_config_descriptor(libusb_device*, uint8_t, libusb_config_descriptor**)</code><br>
     * <i>native declaration : /usr/include/limits.h:862</i><br>
     *
     * @deprecated use the safer method
     * {@link #libusb_get_config_descriptor(libusbone.LibusboneLibrary.libusb_device, byte, libusbone.libusb_config_descriptor.ByReference[])}
     * instead
     */
    @java.lang.Deprecated
    ...
    /**
     * Original signature :
     * <code>int libusb_get_config_descriptor_by_value(libusb_device*, uint8_t, libusb_config_descriptor**)</code><br>
     * <i>native declaration : /usr/include/limits.h:864</i><br>
     *
     * @deprecated use the safer method
     * {@link #libusb_get_config_descriptor_by_value(libusbone.LibusboneLibrary.libusb_device, byte, libusbone.libusb_config_descriptor.ByReference[])}
     * instead
     */
    @java.lang.Deprecated
    ...
    /**
     * Original signature :
     * <code>void libusb_free_config_descriptor(libusb_config_descriptor*)</code><br>
    ...
    /**
     * Original signature :
     * <code>uint8_t libusb_get_bus_number(libusb_device*)</code><br>
    ...
    /**
     * Original signature :
     * <code>uint8_t libusb_get_device_address(libusb_device*)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_get_max_packet_size(libusb_device*, unsigned char)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_get_max_iso_packet_size(libusb_device*, unsigned char)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_open(libusb_device*, libusb_device_handle**)</code><br>
     * <i>native declaration : /usr/include/limits.h:872</i><br>
     *
     * @deprecated use the safer method
     * {@link #libusb_open(libusbone.LibusboneLibrary.libusb_device, libusbone.LibusboneLibrary.libusb_device_handle[])}
     * instead
     */
    @java.lang.Deprecated
    ...
    /**
     * Original signature :
     * <code>void libusb_close(libusb_device_handle*)</code><br>
    ...
    /**
     * Original signature :
     * <code>libusb_device* libusb_get_device(libusb_device_handle*)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_set_configuration(libusb_device_handle*, int)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_claim_interface(libusb_device_handle*, int)</code><br>
     ...
     */
    int libusb_get_string_descriptor_ascii(libusbone.LibusboneLibrary.libusb_device_handle dev, byte desc_index, byte[] data, int length);
...
unsigned int 	timeout	 
    ...
    /**
     * Original signature :
     * <code>int libusb_release_interface(libusb_device_handle*, int)</code><br>
    ...
    /**
     * Original signature :
     * <code>libusb_device_handle* libusb_open_device_with_vid_pid(libusb_context*, uint16_t, uint16_t)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_set_interface_alt_setting(libusb_device_handle*, int, int)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_clear_halt(libusb_device_handle*, unsigned char)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_reset_device(libusb_device_handle*)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_kernel_driver_active(libusb_device_handle*, int)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_detach_kernel_driver(libusb_device_handle*, int)</code><br>
    ...
    /**
     * Original signature :
     * <code>int libusb_attach_kernel_driver(libusb_device_handle*, int)</code><br>
  ...
  */
     ...
     */
    int libusb_control_transfer(libusbone.LibusboneLibrary.libusb_device_handle dev, byte bmRequestType, byte bRequest, short wValue, short wIndex, byte[] data, short wLength, int timeout);
