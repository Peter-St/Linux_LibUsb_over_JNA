...
import se.marell.libusb.*;
import se.marell.libusb.jna.LibUsb;
import se.marell.libusb.jna.LibUsb.libusb_iso_packet_descriptor;
import se.marell.libusb.jna.LibUsb.Libusb_transfer;
import se.marell.libusb.jna.LibUsb.libusb_error;
import se.marell.libusb.jna.LibUsb.libusb_transfer_status;
...
public class Main_old extends javax.swing.JFrame {
    ...
    // Device Variables
    private UsbSystem us;
    private UsbDevice camDevice;
    private Pointer context;
    private final ArrayList<Request_old> xfers = new ArrayList<>();
    ...
    private void startIsoTransferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startIsoTransferActionPerformed
        ...
        try {
            ...
            for (i = 0; i < ACTIVE_URBS; i++) {
                ...
                Request_old req = new Request_old(camDevice, urbPointer[i], PACKETS_PER_REQUEST, MAX_PACKET_SIZE);
    ...
    private LibUsb.Libusb_transfer_cb_fn setTheCallbackFunction() {
        LibUsb.Libusb_transfer_cb_fn callback = new LibUsb.Libusb_transfer_cb_fn() {
            ...
            public void invoke(Pointer transfer) {
                ...
                Request_old xfer = xfers.get(urbNdx);
